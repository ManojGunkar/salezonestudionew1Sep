...
public class AddContact extends AppCompatActivity {
    ...
    private void showOwnersList(){
        AlertDialog.Builder builderSingle = new AlertDialog.Builder(AddContact.this);

        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AddContact.this, android.R.layout.simple_list_item_1);
