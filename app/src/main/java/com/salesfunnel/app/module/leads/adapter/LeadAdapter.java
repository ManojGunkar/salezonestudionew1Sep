...
public class LeadAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LeadAdapter(Context context, List<LeadApi> leads) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case DISPLAYING:
                ...
                break;
            case LOADING:
                viewHolder = new LeadAdapter.LoadingViewHolder(inflater.inflate(R.layout.item_progress, parent, false));
                break;
        }
        return viewHolder;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case DISPLAYING:
                ...
                localViewHolder.leadRoot.setOnClickListener(view -> {
                    Intent detail = new Intent(mContext , LeadDetailActivity.class);
                    detail.putExtra("LEADID", lead.getLeadId());
